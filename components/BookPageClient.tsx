...
const TIME_SLOTS = [
    ...
    return (
        ...
        <nav className="border-b border-zinc-200 dark:border-zinc-800 px-6 py-4 flex items-center justify-between">
            ...
            <div className="w-8 h-8 bg-purple-700 rounded-lg flex items-center justify-center text-sm">✂️</div>
        ...
        <div className="max-w-2xl mx-auto px-6 py-10">
            <div className="mb-8">
            <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Book Appointment</h1>
            <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-1">Select your preferred date and time</p>
            </div>
            ...
            {error && (
            <div className="mb-4 px-4 py-3 rounded-xl bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 text-sm">{error}</div>
            )}
            {success && (
            <div className="mb-4 px-4 py-3 rounded-xl bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 text-green-600 dark:text-green-400 text-sm">{success}</div>
            )}

            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 mb-4">
            <h2 className="font-semibold text-zinc-900 dark:text-white mb-4">📅 Select Date</h2>
            <input
                type="date"
                min={today}
                value={selectedDate}
            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 mb-6">
                <h2 className="font-semibold text-zinc-900 dark:text-white mb-4">🕐 Select Time Slot</h2>
            ...
            <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 mb-6">
                <h2 className="font-semibold text-zinc-900 dark:text-white mb-3">📋 Booking Summary</h2>
